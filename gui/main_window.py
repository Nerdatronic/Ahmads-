...
class MainWindow:
    ...
    def _setup_layout(self):
        ...
        self.visualization_panel.pack(fill=tk.BOTH, expand=True, padx=5, pady=5)
        ...
        self.metrics_panel.pack(fill=tk.BOTH, expand=True, padx=5, pady=5)
        ...
        self.terminal_panel.pack(fill=tk.BOTH, expand=True)
